...
from antbot.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
...
class SubagentManager:
    ...
    async def _run_subagent(
        ...
        try:
            ...
            tools.register(WebSearchTool(api_key=self.brave_api_key, proxy=self.web_proxy, searxng_url=self.searxng_url))
