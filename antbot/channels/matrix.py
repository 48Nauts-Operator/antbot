...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install antbot-ai[matrix]"
    ) from e

from antbot.bus.events import OutboundMessage
from antbot.channels.base import BaseChannel
from antbot.config.paths import get_data_dir, get_media_dir
from antbot.utils.helpers import safe_filename
