...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.antbot/workspace"
    model: str = "local/auto"  # Default to local model auto-detection
    provider: str = (
        "auto"  # Provider name or "auto" for auto-detection (local first)
    )
...
class Config(BaseSettings):
    ...
    model_config = ConfigDict(env_prefix="ANTBOT_", env_nested_delimiter="__")
