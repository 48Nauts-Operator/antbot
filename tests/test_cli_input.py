...
from antbot.cli import commands
...
def mock_prompt_session():
    ...
    with patch("antbot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("antbot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("antbot.cli.commands.PromptSession") as MockSession, \
         patch("antbot.cli.commands.FileHistory") as MockHistory, \
