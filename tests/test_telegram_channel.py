...
from antbot.config.schema import TelegramConfig
...
class _FakeBot:
    ...
    async def get_me(self):
        return SimpleNamespace(username="antbot_test")
...
async def test_start_uses_request_proxy_without_builder_proxy(monkeypatch) -> None:
    ...
    monkeypatch.setattr("antbot.channels.telegram.HTTPXRequest", _FakeHTTPXRequest)
    monkeypatch.setattr(
        "antbot.channels.telegram.Application",
